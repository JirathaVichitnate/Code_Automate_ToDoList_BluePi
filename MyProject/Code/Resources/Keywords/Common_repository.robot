...
${Title_ToDoList}            //h1[text()='To Do List']
${Menu_AddItem}              //a[text()='Add Item']
${Menu_ToDoTasks}              //a[text()='To-Do Tasks']
${Menu_Completed}           //a[text()='Completed']
${input_list_textbox}                //input[@id="new-task"]

${Read_Book_TextList}       //span[text()='Read Book']
${Sing_Song_TextList}      //span[text()='ร้องเพลง']
${Movie_Part_1_TextList}     //span[text()='ดูหนังภาค1']
${WorkOut_TextList}     //span[contains(text(),'Workout')]
${Add_Button}       //i[text()='add']
${Read_Book_TextList_Completed_Menu}    //button[text()='Delete']/preceding-sibling::span[text()='Read Book']  #(//span[text()='Read Book'])[2]
${Sing_Song_TextList_Completed_Menu}    //button[text()='Delete']/preceding-sibling::span[text()='ร้องเพลง']
${Moive_Part_1_TextList_Completed_Menu}    //button[text()='Delete']/preceding-sibling::span[text()='ดูหนังภาค1']
${Workout_TextList_Completed_Menu}    //button[text()='Delete']/preceding-sibling::span[contains(text(),'Workout')]
${Delete_Button_Fst_Task_Completed_Menu}     //span[text()='Read Book']/following-sibling::button[text()='Delete']
${Watch_Movie_TextList_Task_ToDoTask_Menu}     //span[text()='Watch Movie']
${Watch_Movie_TextList_Task_ToDoTask_Menu_CheckBox}     //span[text()='Watch Movie']/following::span[@class="mdl-checkbox__box-outline"]
${Watch_Movie_TextList_Completed_Menu}    //button[text()='Delete']/preceding-sibling::span[text()='Watch Movie']   #//input[@type="checkbox"]/following-sibling::span[text()='Watch Movie']   #//input[@type="checkbox"]/following-sibling::span[text()='Watch Movie']   #//button[text()='Delete']/preceding-sibling::span[text()='Watch Movie']
${Watch_Movie_TextList_Completed_Menu_Fst_Task}     //input[@type="checkbox"]/following-sibling::span[text()='Watch Movie']    #(//input[@type="checkbox"]/following-sibling::span[text()='Watch Movie'])[1]
#//button[text()='Delete']/preceding-sibling::span[text()='Watch Movie']
${Delete_Button_Fst_Watch_Movie_Task_Completed_Menu}      //span[text()='Watch Movie']/following-sibling::button[text()='Delete']
${NetFlix_Time_TextList_Task_ToDoTask_Menu}       //span[text()='NetFlix Time']
${Delete_Button_Fst_Watch_Movie_Task_ToDoTasks_Menu}      (//span[text()='NetFlix Time']/following::button[text()='Delete'])[1]
${Delete_Button_Fst_SingSong_Task_Completed_Menu}       //span[text()='ร้องเพลง']/following-sibling::button[text()='Delete']
${Delete_Button_Fst_MoviePart1_Task_Completed_Menu}     //span[text()='ดูหนังภาค1']/following-sibling::button[text()='Delete']
${Delete_Button_Fst_Workout_Task_Completed_Menu}     //span[contains(text(),'Workout')]/following-sibling::button[text()='Delete']
${Plant_TextList_Task_ToDoTask_Menu}            //span[text()='ปลูกป่า']
${Movie_Part_2_TextList_Task_ToDoTask_Menu}         //span[text()='ดูหนังภาค2']
${Delete_Button_Fst_Plant_Task_ToDoTasks_Menu}     (//span[text()='ปลูกป่า']/following::button[text()='Delete'])[1]
${Delete_Button_Fst_Movie_Part_2_ToDoTasks_Menu}     (//span[text()='ดูหนังภาค2']/following::button[text()='Delete'])[1]
${Delete_Button_Fst_Workout_ToDoTasks_Menu}     (//span[contains(text(),'Workout')]/following::button[text()='Delete'])[1]




${LoginUser}                //input[@placeholder="Username"]
${LoginPass}                //input[@placeholder="Password"]
${LoginButt}                //span[text()='Sign in']
${pay}                      //h6[text()='ชำระเงิน']
${Select_Customer_Type_Text}        //p[text()='เลือกประเภทของลูกค้า']
${Member_Button}    //p[text()='สมาชิก']
${Search_Member}    //input[@placeholder="ชื่อหรือเบอร์โทรศัพท์ของสมาชิก"]
${Choose_Platinum}        (//p[text()='Platinum']/following::span)[1]
${Continue_Button}     //span[text()='ดำเนินการต่อ']
${Search_Product}          //input[@placeholder="ค้นหาสินค้า"]
${result_specific_product_01}    //*[text()='FDC_TP_0009']
${search_product_button}           //span[text()='ค้นหา']
${Continue_Button_transaction_process}                  //p[text()='ดำเนินการต่อ']
${Select_Payment_Method}              //p[text()='เลือกวิธีชำระเงิน']
${Cash_Payment_Method}                //p[text()='เงินสด']/parent::div/parent::span/parent::button
...
${Pagination_Next_Button}        //div[text()='Next']   #//a[text()='Next']
...
#----------------------------------------------------------------------------------------------------
${Page_Before_Login}                 //p[text()='Please relogin again']
${OKButton}                //button[text()='OK']
${LoginUserKubota}                         //input[@id=":ra:"]
${LoginPasswordKubota}                      //input[@id=":rb:"]
${SignInButonKubota}                      //button/span[text()='SIGN IN']
${BusinessPortal}                        //h1[text()='Business Portal']
${CustomerMenu}                //div[@id="Customers"]
${Transaction_Sub_Menu}             //h3[text()='Transactions']
${Search_Box}             //input[@id=":ro:"]
${Export_Button}        //p[text()='Export']
${Pagination_Perpage_Button}             //div[text()='Previous']/parent::button/parent::li/following::li      #//button[text()='1']/parent::li
${Showing_Count_Number}          //span[contains(text(),'Showing')]            #//div[contains(text(),'Showing')]
${Table_Row_Count}         //div[@class="rs-table-body-wheel-area"]/div
${Last_Pagination_Number}          //nav[@aria-label="pagination navigation"]//li[last()-1]/button
${ASL_Each_Row_Cost_Per_Unit_Service_One_Time}     (//div[@role="gridcell"][count((//h6[text()='Redeem'])[1]//preceding-sibling::div[@class="rs-table-cell-header"])+6][1]/div)[???]    #//div[@role="gridcell"][count((//h6[text()='Redeem'])[1]//preceding-sibling::div[@class="rs-table-cell-header"])+6][???]/div
${KBT_Type_Each_Row_Cust_Trans}           (//div[@role="gridcell"][count((//h6[text()='Type'])[1]//preceding-sibling::div[@class="rs-table-cell-header"])+3][1]/div)[???]
${KBT_Status_Each_Row_Cust_Trans}           (//div[@role="gridcell"][count((//h6[text()='Type'])[1]//preceding-sibling::div[@class="rs-table-cell-header"])+7][1]//span)[???]
${KBT_Check_Field_Is Visible}         //div[contains(text(),':')]      #(//div[@role="gridcell"][count((//h6[text()='Type'])[1]//preceding-sibling::div[@class="rs-table-cell-header"])+3][1]/div)
${KBT_Reward_Each_Row_Cust_Trans}            (//div[@role="gridcell"][count((//h6[text()='Redeem'])[1]//preceding-sibling::div[@class="rs-table-cell-header"])+5][1]/div)[???]
